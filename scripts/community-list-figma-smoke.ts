...
assert.match(cardSource, /trackViews\?: boolean/u)
assert.doesNotMatch(cardSource, /community-post__view-count/u, '列表暂不展示浏览量')
...
for (const [name, source] of [
  ...
  assert.match(source, /trackViews/u, `${name}未保留曝光上报`)
