...
assert.deepEqual(privateMessageImageFrameSize(1200, 800), { width: 440, height: 293 })
assert.deepEqual(privateMessageImageFrameSize(600, 1200), { width: 220, height: 440 })
...
assert.ok(conversationPage.includes('支持文字、图片和表情'), '私信会话页必须说明支持图片和表情')
