...
assert.ok(communityDetailSource.includes('community-detail-card__images--single'))
...
assert.match(communityDetailStyleSource, /\.community-detail__images \{[\s\S]*?display: grid;[\s\S]*?grid-template-columns: repeat\(3, minmax\(0, 1fr\)\);/u)
assert.match(communityDetailStyleSource, /\.community-detail-card__images--single \{[\s\S]*?max-width: 560rpx;/u)
assert.match(communityDetailStyleSource, /\.community-detail__image-frame \{[\s\S]*?height: 220rpx;/u)
assert.match(communityDetailStyleSource, /\.community-detail-card__images--single \.community-detail__image-frame,[\s\S]*?height: auto;/u)
assert.match(communityDetailStyleSource, /\.community-detail-card__image-reviewing \{[\s\S]*?min-height: 220rpx;/u)
assert.match(communityDetailStyleSource, /\.community-detail-card__images--single \.community-detail-card__image-reviewing \{[\s\S]*?min-height: 320rpx;/u)
assert.match(communityDetailStyleSource, /\.community-detail-card__images--single \.community-detail-card__image-reviewing--overlay \{[\s\S]*?min-height: 0;/u)
