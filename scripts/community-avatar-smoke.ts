...
assert.match(feedStyleSource, /\.community-post__avatar \{[\s\S]*?width: 80rpx;[\s\S]*?height: 80rpx;[\s\S]*?border-radius: 50%;/)
...
assert.ok(homeSource.includes("imageClassName='news-card__avatar-image'"))
