...
assert.match(topicPageSource, /community-topic-class-context__name[\s\S]*?topic\.name/u)
...
assert.match(topicPageSource, /共 \{activeClassParticipation\.participant_count\} 人参与讨论/u, '课堂页应展示参与人数')
