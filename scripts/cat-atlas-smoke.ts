...
assert.match(detail, /cat-detail-live-preview--combined/u, '详情页应将最近动态与目击入口合并')
assert.doesNotMatch(detail, /cat-detail-shortcuts|出没地图|给它留言|cat-detail-bottom/u, '详情页不应展示重复或已下线入口')
