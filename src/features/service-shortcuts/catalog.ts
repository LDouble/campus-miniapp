...
export const serviceGroups: Array<{ title: string; subtitle: string; items: ServiceItem[] }> = [
  {
    ...
    items: [
      ...
      { key: 'grades', name: '成绩查询', route: '/pages/academic/grades/index' },
      ...
      { key: 'course-audit', name: '蹭课检索', route: '/pages/academic/course-catalog/index' },
  ...
  },
  {
    ...
    subtitle: '学习空间与资源',
    items: [
      { key: 'classroom', name: '空教室', route: '/pages/empty-classroom/index' },
  ...
  },
  {
    ...
    subtitle: '日常校园服务',
    items: [
      { key: 'shuttle', name: '校园校车', route: '/pages/shuttle/index' },
      { key: 'carpool', name: '找同行', lifeSection: 'carpool' },
      { key: 'community', name: '校园社区', lifeSection: 'community' },
      { key: 'market', name: '校园二手', lifeSection: 'market' },
