...
export default function Index () {
  ...
  const load = async () => {
    ...
    try { setItems(await getFeed()) } catch (e) { setError((e as Error).message) } finally { setLoading(false); setRefreshing(false) }
  }
  ...
  return <View className='page-shell'>
    ...
    <ScrollView scrollY refresherEnabled refresherTriggered={refreshing} onRefresherRefresh={() => { setRefreshing(true); void load() }} className='home-scroll'>
