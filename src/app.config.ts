...
const packageDefinitions = [
  {
    ...
    pages: ['schedule/index', 'grades/index', 'exams/index', 'selection/index', 'statistics/courses', 'statistics/index', 'course-intelligence/contribute', 'course-catalog/index', 'general-education/index'],
  },
