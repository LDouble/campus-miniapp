...
export type CourseIntelligenceDimension = components['schemas']['CourseIntelligenceDimension']
export type CourseIntelligenceOverview = components['schemas']['CourseIntelligenceOverview']
export type CourseIntelligenceReview = components['schemas']['CourseIntelligenceReviewView']
export type CourseIntelligenceReviewPage = components['schemas']['CourseIntelligenceReviewPage']
export type CourseIntelligenceTeacherFilter = components['schemas']['CourseIntelligenceTeacherFilter']
export type CourseIntelligenceContributionInput = components['schemas']['CourseIntelligenceContributionInput']
export type CourseIntelligenceContributionView = components['schemas']['CourseIntelligenceContributionView']
export type CourseIntelligenceVisibility = components['schemas']['CourseIntelligenceVisibility']
export type CourseIntelligenceAttendedStatus = NonNullable<CourseIntelligenceContributionInput['attended_status']>
